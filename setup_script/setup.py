...
if os.path.exists(jbrowse_data_directory) is False :  #check to make sure that the data is already not loaded into this folder. may be check for jbrowse json data folder
    ...
    print("Directory "+ jbrowse_data_directory +" already exists.")
    os.chmod(jbrowse_data_directory,0o777)
...
if os.path.exists(jbrowse_download_directory) is False : 
    try:
        ...
        print("Directory "+ jbrowse_download_directory +" already exists.")
        os.chmod(jbrowse_download_directory,0o777)
...
if args.skip_download is False:
    ...
    print("--skip-download flag is specified on command line. Skipping downloading data from Ensembl")
...
if args.skip_download_processing is False:
...
if args.skip_jbrowse_load is False:
...
if args.skip_mongo_load is False:

    print("Loading gene annotations and RGENs into Mongo database")
    #insert gene information into Mongo
