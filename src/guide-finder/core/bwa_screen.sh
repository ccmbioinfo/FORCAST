...
bwa aln -n 1 -l 0 -o 0 -t 2 -N "${bwa_index}" "${tempfiles}/${fastafile}" > "${tempfiles}/${saifile}"
...
bwa samse -n 0 "${bwa_index}" "${tempfiles}/${saifile}" "${tempfiles}/${fastafile}" | "${dir_path}/xa2multi.pl" > "${tempfiles}/${samfile}"
